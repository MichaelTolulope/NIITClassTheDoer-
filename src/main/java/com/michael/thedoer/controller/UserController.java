...
import com.michael.thedoer.dto.*;
...
public class UserController {
    ...
    @PatchMapping("/{userId}")
    public ResponseEntity<User> updateUser(@PathVariable Long userId, @RequestBody RegisterUserDto user) {
...
//    user profile for authenticated user
    ...
    public ResponseEntity<UserProfileDto> getProfile(Authentication authentication) {
        ...
        var foundUser = userRepo.findByEmail(email).get();
